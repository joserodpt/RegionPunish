 ...
 */
public class SelectionCube implements Iterable<Block>, Cloneable, ConfigurationSerializable {
     ...
     */
    public SelectionCube(Location l1, Location l2) {
     ...
     */
    public SelectionCube(Location l1) {
        this(l1, l1);
        totalBlocks = getVolume();
     ...
     */
    public SelectionCube(SelectionCube other) {
     ...
     */
    public SelectionCube(World world, int x1, int y1, int z1, int x2, int y2, int z2) {
     ...
     * @param z2        - Z co-ordinate of corner 2
     */
    private SelectionCube(String worldName, int x1, int y1, int z1, int x2, int y2, int z2) {
     ...
     */
    public SelectionCube(Map<String, Object> map) {
     ...
     */
    public SelectionCube expand(CuboidDirection dir, int amount) {
        switch (dir) {
            case North:
                return new SelectionCube(this.worldName, this.x1 - amount, this.y1, this.z1, this.x2, this.y2, this.z2);
            case South:
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, this.x2 + amount, this.y2, this.z2);
            case East:
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1 - amount, this.x2, this.y2, this.z2);
            case West:
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, this.z2 + amount);
            case Down:
                return new SelectionCube(this.worldName, this.x1, this.y1 - amount, this.z1, this.x2, this.y2, this.z2);
            case Up:
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2 + amount, this.z2);
            default:
     ...
     */
    public SelectionCube shift(CuboidDirection dir, int amount) {
     ...
     */
    public SelectionCube outset(CuboidDirection dir, int amount) {
        SelectionCube c;
        switch (dir) {
            case Horizontal:
     ...
     */
    public SelectionCube inset(CuboidDirection dir, int amount) {
     ...
     */
    public SelectionCube contract(CuboidDirection dir) {
        SelectionCube face = getFace(dir.opposite());
        switch (dir) {
            case Down:
                while (face.containsOnly(Material.AIR) && face.getLowerY() > this.getLowerY()) {
                    face = face.shift(CuboidDirection.Down, 1);
                }
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, this.x2, face.getUpperY(), this.z2);
            case Up:
                while (face.containsOnly(Material.AIR) && face.getUpperY() < this.getUpperY()) {
                    face = face.shift(CuboidDirection.Up, 1);
                }
                return new SelectionCube(this.worldName, this.x1, face.getLowerY(), this.z1, this.x2, this.y2, this.z2);
            case North:
                while (face.containsOnly(Material.AIR) && face.getLowerX() > this.getLowerX()) {
                    face = face.shift(CuboidDirection.North, 1);
                }
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, face.getUpperX(), this.y2, this.z2);
            case South:
                while (face.containsOnly(Material.AIR) && face.getUpperX() < this.getUpperX()) {
                    face = face.shift(CuboidDirection.South, 1);
                }
                return new SelectionCube(this.worldName, face.getLowerX(), this.y1, this.z1, this.x2, this.y2, this.z2);
            case East:
                while (face.containsOnly(Material.AIR) && face.getLowerZ() > this.getLowerZ()) {
                    face = face.shift(CuboidDirection.East, 1);
                }
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, face.getUpperZ());
            case West:
                while (face.containsOnly(Material.AIR) && face.getUpperZ() < this.getUpperZ()) {
                    face = face.shift(CuboidDirection.West, 1);
                }
                return new SelectionCube(this.worldName, this.x1, this.y1, face.getLowerZ(), this.x2, this.y2, this.z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
     ...
     */
    public SelectionCube getFace(CuboidDirection dir) {
        switch (dir) {
            case Down:
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y1, this.z2);
            case Up:
                return new SelectionCube(this.worldName, this.x1, this.y2, this.z1, this.x2, this.y2, this.z2);
            case North:
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, this.x1, this.y2, this.z2);
            case South:
                return new SelectionCube(this.worldName, this.x2, this.y1, this.z1, this.x2, this.y2, this.z2);
            case East:
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, this.z1);
            case West:
                return new SelectionCube(this.worldName, this.x1, this.y1, this.z2, this.x2, this.y2, this.z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
     ...
     */
    public SelectionCube getBoundingCuboid(SelectionCube other) {
        if (other == null)
            return this;
        ...
        return new SelectionCube(this.worldName, xMin, yMin, zMin, xMax, yMax, zMax);
    }
    ...
    @Override
    public SelectionCube clone() {
        return new SelectionCube(this);
    }
    ...
    public ArrayList<Player> getPlayersIn() {
        ...
        for (Player p : Bukkit.getOnlinePlayers()) {
            if (this.contains(p.getLocation())) {
                send.add(p);
            }
        }
        return send;
    ...
    public ArrayList<String> getPlayersInName() {
        ArrayList<String> send = new ArrayList<>();
        for (Player p : Bukkit.getOnlinePlayers()) {
            if (this.contains(p.getLocation())) {
                send.add(" - " + p.getDisplayName());
            }
        }
        return send;
    }
